...
// Test
extension IssueTests {
    func testDecodeIssueJSON() {
        decode(json: issueJSON, to: Model.Issue.self)
    }
    
    static var allTests: [(String, (IssueTests) -> () -> ())] {
        return [("testDecodeIssueJSON", testDecodeIssueJSON)]
    }
}

// Test Data
private extension IssueTests {
